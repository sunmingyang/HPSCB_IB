...
function bacck(){
		...
		<table align="left" class="wrapperDataTable" cellpadding="0" cellspacing="0">
			<tr>
				<td  class="wrapperDataTableTR" align="center" > Fund Transfer >>Error ! in Uploading Excel File</td>
			...
			<tr>
                	<td align="center">
				Duplicate Account no in Excel File please check your excel File</td>
