...
function bacck(){
		...
		<table align="left" class="wrapperDataTable" cellpadding="0" cellspacing="0">
			<tr>
				<td  class="wrapperDataTableTR" align="center" > Fund Transfer >>Error ! Amount is not proper format in xls file</td>
			...
			<tr>
                	<td align="center">
				 Amount is not proper formatn in Excel File please check your excel File</td>
