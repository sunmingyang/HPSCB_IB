...
<table align="left" class="wrapperDataTable" cellpadding="0" cellspacing="0">
	<tr >
		<td class="wrapperDataTableTR" align="center">
					Accounts >> TransAction Status</td>
	</tr>
	<tr>
		<td align="center">
...
alert("Please Select Any Type of Status");
	...
	document.forms[0].action= "<%=request.getContextPath()%>/accsum/acc_sum.do?action=trnStatus&trnNo="+trnNo+"&docType="+docType+"&sAccNum="+sAccNum+"&fdate="+fdate+"&statusType="+statusType+"&tdate="+tdate+"&bnkName="+'<%=b_name%>';
