	...
	<div  class="col-md-10" style="border: 1px solid #3143df; padding: 3px;border-radius: 4px;margin-top:1px;">
		<div class="form-group" style="clear:both;">
			<div class="form-group">
				<label class="col-md-3" style="margin-top: 5px;color: rgb(6, 14, 99);font-size: 13px;">Name<span class="required">*</span>&nbsp;:</label> 
				<div class="col-md-3" style="width:17%;">
						<select Class="form-control ipfile" name='scustTTL' id='scustTTL' style="color: #0e010f;" >
				...
				<div class="col-md-6">
					<input type="text" name='custName'  maxlength="90" id='custName' autocomplete="off" placeholder="Enter Name" tabindex="2" style="color:#0e010f;" class = "form-control ipfile validName" />	
				</div>
			</div>
			
		<div class="form-group" style="clear:both;">
			<div class="form-group">
				<label class="col-md-3" style="margin-top: 12px;color: rgb(6, 14, 99);font-size: 13px;" >Father's Name<span class="required">*</span>&nbsp;:</label> 
				<div class="col-md-3" style="width:17%;">
						<select Class="form-control ipfile" name='sFatherTTL' id='sFatherTTL' style="color: #0e010f; margin-top: 5px;" >
							<option value="MR.">MR.</option>
							<option value="MRS.">MRS.</option>
						 </select>
			  </div>
				<div class="col-md-6" >							
						<input type="text" name='fatherName'  maxlength="90" id='fatherName' autocomplete="off" placeholder="Enter Father Name" tabindex="4" style="margin-top: 5px;color:#0e010f;" class = "form-control ipfile validName" />	
				</div>
			</div>
		</div>
		<div class="form-group" style="clear:both;">
				<div class="form-group">
				<label class="col-md-3" style="margin-top: 12px;color: rgb(6, 14, 99);font-size: 13px;">Aadhar No.&nbsp;:</label> 
				<div class="col-md-8">
				<input type="text" name='adharnumber'  maxlength="12" id='adharnumber' autocomplete="off" placeholder="Enter Aadhar No." tabindex="5" style="margin-top:5px;color:#0e010f;" class = "form-control  ipfile adharnumber" onchange = "AadharLengthCheck()"  />	
				</div>
			</div>				
			
		<div class="form-group" style="clear:both;">
			<div class="form-group">
				<label class="col-md-3" style="margin-top: 12px;color: rgb(6, 14, 99);font-size: 13px;">Mobile No. <span class="required">*</span>&nbsp;:</label> 	
				<div class="col-md-8">
				<input type="text" name='mobileNo'   maxlength="12" id='mobileNo' autocomplete="off" placeholder="Enter Mobile No" tabindex="6" style="margin-top:5px;color:#0e010f;" class = "form-control ipfile mobileNo" onchange = "mobileLengthCheck()" />		
				</div>
			</div>			
		...
		<div class="form-group" style="clear:both;">
			<div class="form-group">
				<label class="col-md-3" style="margin-top: 12px;color: rgb(6, 14, 99);font-size: 13px;">Address &nbsp;:</label> 
				<div class="col-md-8">
					<input type="text" name='address'  maxlength="100" id='address' autocomplete="off" placeholder="Enter Address" tabindex="7" style="margin-top:5px;color:#0e010f;" class = "form-control ipfile validName" />
				</div>
			</div>
		</div>
...
<div class="col-md-10" style="float:none;">
	<div class="col-md-6" >
		<html:button styleId="save" property="save" styleClass="btn btn-md ipfile" tabindex="8" onclick="return saveData();"
		 style="background-color: #040878;color: white;margin-top:16px;float: right;width: 50%;" >Save
		</html:button>
	</div>
	<div class="col-md-6" >
		<html:button property="cancel" styleId="cancel"   tabindex="9" onclick = "goToMenu()" styleClass="btn btn-md ipfile" 
