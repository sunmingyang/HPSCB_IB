	...
	response.sendRedirect(appServer+"/CustId/CMMCustomerIdPreAction.do?cmmmode=new&appSrc=TABBANKING&custID="+custID) ; 
	...
	document.getElementById('if').src="<%=appServer%>/CustId/CMMCustomerIdPreAction.do?cmmmode=new&appSrc=TABBANKING&accNo=<%=accountNo%>";
