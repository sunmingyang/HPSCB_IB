...
<script language="JavaScript" src="/fundtransfer/scripts/auth.js"></script>
...
<tiles:insert page="/common/siteLayout.jsp" flush="true">
   ...
   <html:form action="/fundtransfer/fund" >
	<table   width="100%" >
	<tr>
	    <b><bean:message bundle="hindi" key='7017' /></b>
	</tr>
	<br>
	<tr>
	    <td width="50%">
		    <bean:message bundle="hindi" key='43'/>
			
	        </td>
			<td>
		    <html:text property="sDate" styleId="sDate" size="30" readonly="true" />
		</td>
	</tr>
	<br>
	<tr>
	    <td width="50%">
		    <bean:message bundle="hindi" key='6430'/>
	        </td>
			<td>
	...
	<tr>
	    <td width="50%">
		    <bean:message bundle="hindi" key='2436'/>
	        </td>
			<td>
	...
	<tr>
	    <td width="50%">
		<logic:messagesPresent property ="AccNoTo">
	 ...
	 <tr>
	    <td width="50%">
		    <bean:message bundle="hindi" key='39'/> (INR)
	    </td>
		<td>
