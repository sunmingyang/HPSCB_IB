			...
			<td align="center"  >
					...
					<table width="527" id = "accDiv">
						...
						<tr>
							...
							<td>
								<select id="sNickName" style="width:140px;" onchange="getAccNo()">
...
<% if(!(mode.equals("P2P") || mode.equals("P2A"))) {%>
							...
							<tr>
								<td colspan="2">
									<table id="schTable" style="width:100%;display:none;">
										<tr>
											<td style="width:50%" class="normalHeadText">
												Schedule Start Date:
											</td>
											<td>
						...
						<!-- <tr>
							<td colspan="2" align="center">
								...
								&emsp;&emsp; <html:button property="back"  styleClass = "button" onclick="bacck()" >
...
<%if  (custRole.equals("S") || custRole.equals("E") || ((custRole.equals("F") && openFor.equals("A") ))) { %>
<tr><td colspan = "4">
<!-- <%if  (custRole.equals("S")|| custRole.equals("E") || ((custRole.equals("F") && openFor.equals("A") ))) { %> -->
