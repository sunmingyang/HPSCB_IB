...
<%
	...
	{   
		...
		// session.removeAttribute("cibuser"); 
	}
	...
	String message="Transaction Reports";
...
<table id="mainTab" style="width:100%;" cellpadding="0" cellspacing="15" >
				...
				<div style="height:100px;overflow:auto">
					<table width="100%" id = "stmttable">
						...
						<!-- 	Sr.No Name AccountNo IFSC Code Amount Statu -->
							...
							<% if(reportFor.equals("N")){%>
								<td class="dataTableTH"><B>Authorizer Remark </B></td>
			...
			%>  
							<tr>
								...
								<% if(reportFor.equals("N")){%>
									<td   class="dataTableTD">Pending by Authoriser </td> <!-- A1 --> 
