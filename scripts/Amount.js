function amtInWords()
{
	...
	var decAmount=document.forms[0].sTransAmount.value;
	...
	var iLength = ((String)(sAmount)).length;
	document.forms[0].sAmtInWords.size=parseInt(iLength)+10;
	document.forms[0].sAmtInWords.value=sAmount;
