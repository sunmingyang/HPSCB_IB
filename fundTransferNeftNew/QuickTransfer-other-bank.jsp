...
function otp_number(){
	...
	//	var mob=document.getElementById("mob").value;
		...
		var url="/TransactionAction.do?action=sendOTP&userID="+userid+"&beneficiaryAccNo="+id+"&mobile="+mob+"&sessionID=12" +"&ran="+ran+"&DrCr="+drCr+"&DebitAccount="+DebitAccount+"&purpose=Fund Transfer"+"&amount="+amount;
		//alert(url)
...
.amount-selection-main-sec .amount-sec span.ifsc-box {
    width: 66%;
    display: flex;
    flex-wrap: wrap;
    ...
    .amount-selection-main-sec .amount-sec span.amt-inner {
    margin: 0 0 20px;
}

.amount-selection-main-sec .amount-sec span.ifsc-box span.inner {
    width: 32%;
}

.amount-selection-main-sec .amount-sec span.ifsc-box span.inner span.lable {
    font-size: 18px;
    font-weight: 500;
}

.amount-selection-main-sec .amount-sec span.ifsc-box span.inner p {
    height: 50px;
      ...
      <section class="PAYMENTS-TRANSFER-main  funds-tra my-5">
         <div class="container">
           <!-- <div class="selcet-neft-and-rtgs my-3">
                ...
                <span class="neft">
                    NEFT
                    <input type="radio" name="trnType" id="neftrtgs1" value="neft" onclick="selectValue()" />
                </span>
                <span class="neft">
                    RTGS
                    <input type="radio" name="trnType" id="neftrtgs2" value="rtgs" onclick="selectValue()" />
                </span>
				</div>-->
            ...
            <div class="payments-and-transfer-inner">
               <div class="row">
                  ...
                  <div class="pay-heading">
                     <h2>
                        <img src="/styles/images/desktop-bank-transfer-icon 1.png" alt="">
                         Quick Transfer(Other Bank)
                     </h2>
                  </div>

                  <div class="chosse-an-account">
                     <h3>Select the account from which you wish to transfer funds</h3>
                     <select property="sAccountType" id="accList" name="sUsrList1" list="AccountNoList" listkey="custId" listValue="accountNo" onchange="radioClick(this.value)" />
                        <%if (accListArr != null) { %>       
                        ...
                        <%-- <option value=""><span class="name">Saving A/C</span> <span class="accountnu">123XX678XXX234XX</span> </option>
                        <option value=""><span class="name">Current A/C </span> <span class="accountnu">123XX678XXX234XX</span> </option> --%>
                    </select>
                   </div>
                        ...
                        <%-- <a href="/addPayee/addManagePayee.jsp">
                            Click here to add a new Other Bank Beneficiary / Change Limit
                                ...
                                <span class="amt-inner">
                                    ...
                                    <input type="text" id="beneficiaryHName">
                                </span>

                                 <span class="amt-inner">
                            <label class="find-ifsc" for="">IFSC* <a href="">Find IFSC</a></label>
                            <input type="text" name="rifsc"  
												 value="" id="rIFSC1" onblur="ifscTable()" />
                        </span>
                                 ...
                                 <span class="ifsc-box">
                                        <span class="inner"> 
                                            ...
                                            <span class="inner">
                                                <span class="lable">Branch Code:</span> 
                                ...
                                <input type="hidden" id="sAccountType">
                        
                    </div>

                    <%-- <div class="select-the-benificery-account">
                        <div class="chosse-an-account">
                            <select name="sNickName" id="sNickName" onchange="getPayeeDetail(this.value)">
...
<span class="input-paid">
                    ...
                    <div class="buttons">
                        <button type="button" name="ok" value="SUBMIT" id="ok" class="submit-button"><img src="/styles/images/submit.png" alt=""> SUBMIT</button>
                        
                        <button type="button" ><img src="/styles/images/cancle.png" alt=""> <a href="/dashBoard/dashboard.jsp">CANCEL</a></button>
                    </div>
...
<section  class="transction-succesfull-popup">
                <div class="confirm-inner">
                    ...
                    <div class="confi-table">
                        ...
                        <span class="con-details">
                            <span>Remark:</span>
                           	<span id="dremark1" name="remark"></span>
                        </span>
	
						<span class="con-details">
                            <span>IFSC :</span>
                            <span id="rIFSCCode" name="rIFSC1"></span>
                        </span>
                    ...
                    <div class="buttons confirm-detailsss">
                        <button type="button" class="done" onclick="window.location.href = '/sfmsneft/SaveNeft.do?action=getAccountDataQuickTransferOtherBank'"> DONE</button>                        
                    </div>
                </div>
            </section>
 ...
 <input type="hidden" style="margin-left: px;" maxlength="35"
      ...
      <script>
         ...
         jQuery(".submit-button").click(function(){  
			...
			var arIFSC= document.getElementById("rIFSC1").value;
		 ...
		 */
         ...
         jQuery(".AUTHENTICATE").click(function(){
			...
			var aarIFSC= document.getElementById("rIFSC1").value;
			$('#dremark2').html(aremark);						
			$('#fAc2').html(acNo);
			$('#tAc2').html(acNo2);
			$('#damt2').html(aamt);		
            $('#dremark1').html(document.getElementById("remark").value);	
            $('#rIFSCCode').html(document.getElementById("rIFSC1").value);		
...
function otp_numberWithInBank(date){
    ...
    <script>
        function ifscTable(){ 
        alert("ifsc table is calling");
        var ifsc=document.getElementById("rIFSC1").value;    
        rIFSC1    
