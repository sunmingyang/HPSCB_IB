				...
				if (trDetails != "null") {
					...
					if(data.length==1) {
						document.getElementById("chequeTable2").rows[0].cells[1].innerHTML=name;
      					...
      					document.getElementById("chequeTable2").rows[0].cells[1].innerHTML="Multi-Purpose Cheque";
      				}					
			...
			<html:form action="/request/reqchk.do">
				...
				<table align="left" class="wrapperDataTable" cellpadding="0"
					...
					cellspacing="0">
											...
											<tr>
												<td colspan="2">
													<div id="confirmDiv" style="overflow:auto;height:80px;display:none; width:100%"><table id="confirmData" align="center" border="1"
														...
														<tr>
															<td align="center"><input type="button"
																...
																onClick="return back(1)" class="Button" value="Cancel">
