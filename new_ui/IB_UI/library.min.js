...
(function(a){a.fn.facebook_login=function(b){var f={display:"popup",permissions:"email",initwait:2,onInit:function(g){if(g){console.log([200,"OK"])}else{console.log([500,"Error"])}},onLogin:function(g){console.log(g)},onError:function(g){console.log([500,g])}};var e=a.extend({},f,b);if(e.appId==="undefined"){e.onError("config");return false}a.getScript("/assets/js/lib/all.js",function(){if(FB){FB.init({appId:e.appId})}});var d=0;setTimeout(c,3000);function c(){if(typeof FB==="object"){e.onInit(true)}else{if(d>e.initwait){e.onError("timeout")}else{d=d+1;setTimeout(c,3000)}}}this.bind("click",function(){FB.login(function(g){if(g.status==="connected"){e.onLogin(g.authResponse)}else{if(g.status==="not_authorized"){e.onError("authorize")}else{e.onError("cancelled")}}},{scope:e.permissions,display:e.display})})}})(jQuery);(function($){$.browserTest=function(a,z){var u='unknown',x='X',m=function(r,h){for(var i=0;i<h.length;i=i+1){r=r.replace(h[i][0],h[i][1]);}return r;},c=function(i,a,b,c){var r={name:m((a.exec(i)||[u,u])[1],b)};r[r.name]=true;r.version=(c.exec(i)||[x,x,x,x])[3];if(r.name.match(/safari/)&&r.version>400){r.version='2.0';}if(r.name==='presto'){r.version=($.browser.version>9.27)?'futhark':'linear_b';}r.versionNumber=parseFloat(r.version,10)||0;r.versionX=(r.version!==x)?(r.version+'').substr(0,1):x;r.className=r.name+r.versionX;return r;};a=(a.match(/Opera|Navigator|Minefield|KHTML|Chrome/)?m(a,[[/(Firefox|MSIE|KHTML,\slike\sGecko|Konqueror)/,''],['Chrome Safari','Chrome'],['KHTML','Konqueror'],['Minefield','Firefox'],['Navigator','Netscape']]):a).toLowerCase();$.browser=$.extend((!z)?$.browser:{},c(a,/(camino|chrome|firefox|netscape|konqueror|lynx|msie|opera|safari)/,[],/(camino|chrome|firefox|netscape|netscape6|opera|version|konqueror|lynx|msie|safari)(\/|\s)([a-z0-9\.\+]*?)(\;|dev|rel|\s|$)/));$.layout=c(a,/(gecko|konqueror|msie|opera|webkit)/,[['konqueror','khtml'],['msie','trident'],['opera','presto']],/(applewebkit|rv|konqueror|msie)(\:|\/|\s)([a-z0-9\.]*?)(\;|\)|\s)/);$.os={name:(/(win|mac|linux|sunos|solaris|iphone)/.exec(navigator.platform.toLowerCase())||[u])[0].replace('sunos','solaris')};if(!z){$('html').addClass([$.os.name,$.browser.name,$.browser.className,$.layout.name,$.layout.className].join(' '));}};$.browserTest(navigator.userAgent);})(jQuery);(function(b){b.reject=function(f){var a=b.extend(!0,{reject:{all:!1,msie5:!0,msie6:!0},display:[],browserShow:!0,browserInfo:{firefox:{text:"Firefox 16",url:"http://www.mozilla.com/firefox/"},safari:{text:"Safari 5",url:"http://www.apple.com/safari/download/"},opera:{text:"Opera 12",url:"http://www.opera.com/download/"},chrome:{text:"Chrome 22",url:"http://www.google.com/chrome/"},msie:{text:"Internet Explorer 9",url:"http://www.microsoft.com/windows/Internet-explorer/"},gcf:{text:"Google Chrome Frame",
...
(function(d,b,f,c){var a=d(b);d.fn.lazyload=function(h){function i(){var k=0;j.each(function(){var l=d(this);if(e.skip_invisible&&!l.is(":visible")){return}if(d.abovethetop(this,e)||d.leftofbegin(this,e)){}else{if(!d.belowthefold(this,e)&&!d.rightoffold(this,e)){l.trigger("appear");k=0}else{if(++k>e.failure_limit){return false}}}})}var j=this;var g;var e={threshold:0,failure_limit:0,event:"scroll",effect:"show",container:b,data_attribute:"original",skip_invisible:true,appear:null,load:null,placeholder:"image"};if(h){if(c!==h.failurelimit){h.failure_limit=h.failurelimit;delete h.failurelimit}if(c!==h.effectspeed){h.effect_speed=h.effectspeed;delete h.effectspeed}d.extend(e,h)}g=e.container===c||e.container===b?a:d(e.container);if(0===e.event.indexOf("scroll")){g.bind(e.event,function(){return i()})}this.each(function(){var k=this;var l=d(k);k.loaded=false;if(l.attr("src")===c||l.attr("src")===false){if(l.is("img")){l.attr("src",e.placeholder)}}l.one("appear",function(){if(!this.loaded){if(e.appear){var m=j.length;e.appear.call(k,m,e)}d("<img />").bind("load",function(){var p=l.attr("data-"+e.data_attribute);l.hide();if(l.is("img")){l.attr("src",p);l.toggleClass("lazy")}else{l.css("background-image","url('"+p+"')");l.toggleClass("lazy")}l[e.effect](e.effect_speed);k.loaded=true;var n=d.grep(j,function(q){return !q.loaded});j=d(n);if(e.load){var o=j.length;e.load.call(k,o,e)}}).attr("src",l.attr("data-"+e.data_attribute))}});if(0!==e.event.indexOf("scroll")){l.bind(e.event,function(){if(!k.loaded){l.trigger("appear")}})}});a.bind("resize",function(){i()});if(/(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion)){a.bind("pageshow",function(k){if(k.originalEvent&&k.originalEvent.persisted){j.each(function(){d(this).trigger("appear")})}})}d(f).ready(function(){i()});return this};d.belowthefold=function(h,e){var g;if(e.container===c||e.container===b){g=(b.innerHeight?b.innerHeight:a.height())+a.scrollTop()}else{g=d(e.container).offset().top+d(e.container).height()}return g<=d(h).offset().top-e.threshold};d.rightoffold=function(h,e){var g;if(e.container===c||e.container===b){g=a.width()+a.scrollLeft()}else{g=d(e.container).offset().left+d(e.container).width()}return g<=d(h).offset().left-e.threshold};d.abovethetop=function(h,e){var g;if(e.container===c||e.container===b){g=a.scrollTop()}else{g=d(e.container).offset().top}return g>=d(h).offset().top+e.threshold+d(h).height()};d.leftofbegin=function(h,e){var g;if(e.container===c||e.container===b){g=a.scrollLeft()}else{g=d(e.container).offset().left}return g>=d(h).offset().left+e.threshold+d(h).width()};d.inviewport=function(e,g){return !d.rightoffold(e,g)&&!d.leftofbegin(e,g)&&!d.belowthefold(e,g)&&!d.abovethetop(e,g)};d.extend(d.expr[":"],{"below-the-fold":function(e){return d.belowthefold(e,{threshold:0})},"above-the-top":function(e){return !d.belowthefold(e,{threshold:0})},"right-of-screen":function(e){return d.rightoffold(e,{threshold:0})},"left-of-screen":function(e){return !d.rightoffold(e,{threshold:0})},"in-viewport":function(e){return d.inviewport(e,{threshold:0})},"above-the-fold":function(e){return !d.belowthefold(e,{threshold:0})},"right-of-fold":function(e){return d.rightoffold(e,{threshold:0})},"left-of-fold":function(e){return !d.rightoffold(e,{threshold:0})}})})(jQuery,window,document);
/*!
