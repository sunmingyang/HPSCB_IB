	...
	<div class="clearfix">
		...
		<div id="sliderFrame" style="z-index: -9999; height: 480px;">
			<div id="slider"
				...
				<a title="Provogue Watch Offer" href="https://infinity.HPSCBbank.com/corp/AuthenticationController?FORMSGROUP_ID__=AuthenticationFG&amp;__START_TRAN_FLAG__=Y&amp;FG_BUTTONS__=LOAD&amp;ACTION.LOAD=Y&amp;AuthenticationFG.LOGIN_FLAG=1&amp;BANK_ID=ICI" onclick="dataLayer.push({'event':'GAevent', 'gaEventCategory':'internet-banking-provogue-fashion', 'gaEventAction':'desktop-banner-click', 'gaEventLabel':'ib-index-banner'}) "><img alt="Accounts And Deposits" data-original="/managed-assets/images/personal/internet-banking/desktop-banner/provogue-offer-for-ib-d.jpg" src="<%=request.getContextPath()%>/new_ui/IB_UI/images/slider/account-nd-deposits1.jpg" class="desktop lazy"></a>
		...
		<div class="middleContainer clearfix bggrey" style="margin-top:20px;">
					<div class="leftColumnContainer" data-content="See More">
						<ul data-content="See More" style="list-style: none;">
							<li><a class="selected" href="<%=request.getContextPath()%>/new_ui/products/account-nd-deposits.jsp?src=toptitle">Accounts<span>›</span></a></li>
							<li><a	 href="<%=request.getContextPath()%>/new_ui/products/deposits.jsp?src=toptitle">Deposits<span>›</span></a></li>
						<!--<li><a
					...
					<div class="rightColumnContainer">
						<h1 id="toptitle">Accounts</h1>
		<div class="product-overview-content" style="height:100%;">
			<div class="product-overview-article" style="margin-top:-5px;">
				<p>An expansive ATM network; mobile, phone, internet, doorstep
					banking; customised loan products and a wide range of accounts and
					deposits — personalised banking climbs a notch higher with HPSCB
					Bank.</p>
				<hr>
				...
				<p>With Regular Savings Account you can enjoy a large number of
						value-added benefits. Get delighted with rewards, security and
						ease of banking.</p>
				<hr>
				<h3>
					<a href="">3-in-1
				...
				<p>
					Link your banking, trading and demat accounts with our
					Seamless, Secure and Integrated 3-in-1 trading platform.
					<a	href=""	onclick=""	class="apply-now-btn" target="_self">Apply Now</a>
				</p>
				...
				<p>Try our salary account — a win-win offer for employees and
						employers alike.</p>
				<hr>
				<h3>
					<a
				...
				<p>For a financial &amp; secure future, now you can plan your
						retirement with HPSCB Bank</p>
				<hr>
				<h3>
					<a
						href="">Other
				...
				<p>You would also like to look at our other product offerings
						which would suit you the most.</p>
				<hr>
				<h3>
		...
		<div class="page-aside">
			<a class="page-aside-header" href="" onclick="" style="color:#053c6d;">Personal
				Loan Linked to Home Loan<i class="icon-angle-right"></i>
			</a>
			<div class="page-aside-article">
				<a	href=""	onclick="">
				<img data-original="/managed-assets/images/cross-sell/pl-to-hl-cross-sell.jpg"
					src="<%=request.getContextPath()%>/new_ui/IB_UI/images/pl-to-hl-cross-sell.jpg"
					class="" style="display: inline;"></a>
				<p></p>
				<p>
					Meet your Home and Personal requirements at low EMIs. <a
